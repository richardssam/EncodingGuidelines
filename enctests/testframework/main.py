...
def idiff_compare(source_clip, test_ref, testname, comparisontestinfo, source_path, distorted, log_file_object):
    ...
    default_extract_template = "ffmpeg -y -i {newfile} -compression_level 10 -sws_flags area+accurate_rnd -pred mixed -pix_fmt rgb48be -vf scale=in_color_matrix=bt709:out_color_matrix=bt709  -frames:v 1 {newpngfile}"
