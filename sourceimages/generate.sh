...
ffmpeg  -y -i chip-chart-1080-16bit-noicc.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p10le \
...
ffmpeg  -y -f rawvideo -pixel_format yuv422p10le -video_size 1920x1080 -i chip-chart-1080-noicc-yuv422p10le.yuv -pix_fmt rgba64be \
   -sws_flags area+accurate_rnd -frames:v 1 \
...
ffmpeg  -y -i chip-chart-1080-16bit-noicc.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv420p10le \
...
ffmpeg  -y -i chip-chart-1080-16bit-noicc.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv420p \
...
ffmpeg  -y -i chip-chart-1080-16bit-noicc.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p \
...
#smptehdbars_16.png
ffmpeg  -y -i smptehdbars_16.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p10le \
...
ffmpeg  -y -i smptehdbars_16.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv420p10le \
...
ffmpeg  -y -i smptehdbars_16.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv420p \
...
ffmpeg  -y -i smptehdbars_16.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p \
...
# 420 image
ffmpeg -y -i smptehdbars_10.dpx -frames:v 1 -sws_flags spline+accurate_rnd+full_chroma_int -pix_fmt yuv420p10le  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -strict -1 -y smptehdbars_10_yuv420p10le.y4m
...
# 422 image
ffmpeg -y -i smptehdbars_10.dpx -frames:v 1 -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p10le  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -strict -1 -y smptehdbars_10_yuv422p10le.y4m
ffmpeg -y -i smptehdbars_10_yuv422p10le.y4m -sws_flags area+accurate_rnd -pix_fmt rgba64be \
   -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -frames:v 1 \
...
#ffmpeg -y -i smpte_dpx/smptehdbars_10_resolve2_00086400.dpx -frames:v 1 -sws_flags 'area+accurate_rnd+full_chroma_int' -pix_fmt yuv422p10le  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -strict -1 -y smptehdbars_10_yuv422p10le_resolvedpx_pixfmt_area.y4m
#ffmpeg -y -i smpte_dpx/smptehdbars_10_resolve2_00086400.dpx -frames:v 1 -sws_flags 'area+accurate_rnd+full_chroma_int' -vf scale=in_color_matrix=bt709:out_color_matrix=bt709,format=yuv422p10le -strict -1 -y smptehdbars_10_yuv422p10le_resolvedpx_vf2.y4m
#fmpeg -y -i smpte_dpx/smptehdbars_10_resolve2_00086400.dpx -frames:v 1 -sws_flags 'area+accurate_rnd+full_chroma_int' -vf scale=in_color_matrix=bt709:out_color_matrix=bt709,format=yuv422p10le -strict -1 -y smptehdbars_10_yuv422p10le_resolvedpx_vf2_noarea.y4m

#ffmpeg -y -i smptehdbars_10.dpx -frames:v 1 -pix_fmt yuv422p10le  -c:v v210 -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -y smptehdbars_10_yuv422p10le.mov


# ffmpeg -y -i smptehdbars_10.dpx -frames:v 1 -pix_fmt yuv422p10le  -sws_flags area+accurate_rnd+full_chroma_int -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -strict -1 -y smptehdbars_10_yuv422p10le_accurate.y4m
# ffmpeg -y -i smptehdbars_10_yuv422p10le.y4m -pix_fmt rgba64be \
#    -sws_flags area+area+accurate_rnd+full_chroma_int -frames:v 1 \
...
# ffmpeg -y -i smptehdbars_10_yuv422p10le.y4m -pix_fmt rgba64be \
#    -sws_flags area+accurate_rnd+full_chroma_int -frames:v 1 \
...
# 420 image
ffmpeg -y -i smptehdbars_12.dpx -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv420p10le  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -y smptehdbars_12_yuv420p10le.yuv
...
# 422 image
ffmpeg -y -i smptehdbars_12.dpx -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p10le  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -y smptehdbars_12_yuv422p10le.yuv
...
# 420 image
ffmpeg -y -i smptehdbars_8.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv420p  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -y smptehdbars_8_yuv420p.yuv
...
# 422 image
ffmpeg -y -i smptehdbars_8.png -frames:v 1 -c:v rawvideo -sws_flags area+accurate_rnd+full_chroma_int -pix_fmt yuv422p  -vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -y smptehdbars_8_yuv422p.yuv
